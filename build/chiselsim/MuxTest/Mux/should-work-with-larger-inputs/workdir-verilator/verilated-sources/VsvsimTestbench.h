...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    static void getBitWidthImpl_out_0(int* value);
    static void getBitWidthImpl_out_1(int* value);
    static void getBitWidthImpl_out_2(int* value);
    static void getBitWidthImpl_out_3(int* value);
    static void getBitWidthImpl_reset(int* value);
    static void getBitWidthImpl_sel(int* value);
    ...
    static void getBitsImpl_out_0(svBitVecVal* value_out_0);
    static void getBitsImpl_out_1(svBitVecVal* value_out_1);
    static void getBitsImpl_out_2(svBitVecVal* value_out_2);
    static void getBitsImpl_out_3(svBitVecVal* value_out_3);
    static void getBitsImpl_reset(svBitVecVal* value_reset);
    static void getBitsImpl_sel(svBitVecVal* value_sel);
    ...
    static void setBitsImpl_sel(const svBitVecVal* value_sel);
