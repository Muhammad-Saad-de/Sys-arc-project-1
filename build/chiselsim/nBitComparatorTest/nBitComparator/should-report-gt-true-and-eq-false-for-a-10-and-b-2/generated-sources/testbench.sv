module svsimTestbench;
  ...
  wire [$bits(dut.gt)-1:0] gt;
  wire [$bits(dut.eq)-1:0] eq;
...
nBitComparator dut (
  ...
  // Port a: gt
  export "DPI-C" function getBitWidthImpl_gt;
  function void getBitWidthImpl_gt;
    output int value;
    value = $bits(dut.gt);
  endfunction
  export "DPI-C" function getBitsImpl_gt;
  function void getBitsImpl_gt;
    output bit [$bits(dut.gt)-1:0] value_gt;
    value_gt = gt;
  endfunction

  // Port b: eq
  export "DPI-C" function getBitWidthImpl_eq;
  function void getBitWidthImpl_eq;
    output int value;
    value = $bits(dut.eq);
  endfunction
  export "DPI-C" function getBitsImpl_eq;
  function void getBitsImpl_eq;
    output bit [$bits(dut.eq)-1:0] value_eq;
    value_eq = eq;
  endfunction
