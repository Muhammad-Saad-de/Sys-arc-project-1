...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    static void getBitWidthImpl_eq(int* value);
    static void getBitWidthImpl_gt(int* value);
    ...
    static void getBitsImpl_eq(svBitVecVal* value_eq);
    static void getBitsImpl_gt(svBitVecVal* value_gt);
