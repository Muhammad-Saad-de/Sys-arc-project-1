...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench___024root final {
  public:
    ...
    CData/*0:0*/ svsimTestbench__DOT__a;
    CData/*0:0*/ svsimTestbench__DOT__b;
    CData/*0:0*/ svsimTestbench__DOT__cin;
    CData/*0:0*/ svsimTestbench__DOT__dut__DOT__ha2__DOT__a;
