...
void getBitWidth_cin(int* result) {
           svScope prev = setScopeToTestBench();
           getBitWidthImpl_cin(result);
           svSetScope(prev);
        }
void getBits_cin(svBitVecVal* result) {
           svScope prev = setScopeToTestBench();
           getBitsImpl_cin(result);
           svSetScope(prev);
        }
void setBits_cin(const svBitVecVal* data) {
           svScope prev = setScopeToTestBench();
           setBitsImpl_cin(data);
           svSetScope(prev);
        }
void getBitWidth_sum(int* result) {
           svScope prev = setScopeToTestBench();
           getBitWidthImpl_sum(result);
           svSetScope(prev);
        }
void getBits_sum(svBitVecVal* result) {
           svScope prev = setScopeToTestBench();
           getBitsImpl_sum(result);
           svSetScope(prev);
        }
  ...
  switch (id) {
    ...
    case 3: // b
      ...
      *getter = (void(*)(uint8_t*))getBits_b;
      return 0;
    case 4: // cin
      getBitWidth_cin(bitWidth);
      *getter = (void(*)(uint8_t*))getBits_cin;
      return 0;
    case 5: // sum
      getBitWidth_sum(bitWidth);
      *getter = (void(*)(uint8_t*))getBits_sum;
      return 0;
    case 6: // cout
...
int port_setter(int id, int *bitWidth, void (**setter)(const uint8_t*)) {
  switch (id) {
    ...
    case 4: // cin
      getBitWidth_cin(bitWidth);
      *setter = (void(*)(const uint8_t*))setBits_cin;
      return 0;
    default:
      return -1;
  }
