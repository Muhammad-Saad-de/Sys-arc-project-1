module svsimTestbench;
  ...
  reg  [$bits(dut.cin)-1:0] cin = '0;
  wire [$bits(dut.sum)-1:0] sum;
...
FullAdder dut (
  ...
  // Port 4: cin
  export "DPI-C" function getBitWidthImpl_cin;
  function void getBitWidthImpl_cin;
    output int value;
    value = $bits(dut.cin);
  endfunction
  export "DPI-C" function setBitsImpl_cin;
  function void setBitsImpl_cin;
    input bit [$bits(dut.cin)-1:0] value_cin;
    cin = value_cin;
  endfunction
  export "DPI-C" function getBitsImpl_cin;
  function void getBitsImpl_cin;
    output bit [$bits(dut.cin)-1:0] value_cin;
    value_cin = cin;
  endfunction

  // Port 5: sum
  export "DPI-C" function getBitWidthImpl_sum;
  function void getBitWidthImpl_sum;
    output int value;
    value = $bits(dut.sum);
  endfunction
  export "DPI-C" function getBitsImpl_sum;
  function void getBitsImpl_sum;
    output bit [$bits(dut.sum)-1:0] value_sum;
    value_sum = sum;
  endfunction
