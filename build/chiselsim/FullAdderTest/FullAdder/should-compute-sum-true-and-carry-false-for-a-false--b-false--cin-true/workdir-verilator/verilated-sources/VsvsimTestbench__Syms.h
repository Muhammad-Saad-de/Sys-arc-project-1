...
using VsvsimTestbench__Vcb_getBitWidthImpl_cin_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value);
...
using VsvsimTestbench__Vcb_getBitWidthImpl_sum_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value);
using VsvsimTestbench__Vcb_getBitsImpl_a_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_a);
using VsvsimTestbench__Vcb_getBitsImpl_b_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_b);
using VsvsimTestbench__Vcb_getBitsImpl_cin_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_cin);
...
using VsvsimTestbench__Vcb_getBitsImpl_sum_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_sum);
using VsvsimTestbench__Vcb_setBitsImpl_a_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ value_a);
using VsvsimTestbench__Vcb_setBitsImpl_b_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ value_b);
using VsvsimTestbench__Vcb_setBitsImpl_cin_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ value_cin);
