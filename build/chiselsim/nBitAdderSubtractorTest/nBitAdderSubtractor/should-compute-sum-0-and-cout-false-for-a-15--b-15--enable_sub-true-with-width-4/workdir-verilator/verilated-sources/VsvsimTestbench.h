...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    static void getBitWidthImpl_cout(int* value);
    static void getBitWidthImpl_enable_sub(int* value);
    static void getBitWidthImpl_reset(int* value);
    static void getBitWidthImpl_sum_0(int* value);
    static void getBitWidthImpl_sum_1(int* value);
    static void getBitWidthImpl_sum_2(int* value);
    static void getBitWidthImpl_sum_3(int* value);
    ...
    static void getBitsImpl_cout(svBitVecVal* value_cout);
    static void getBitsImpl_enable_sub(svBitVecVal* value_enable_sub);
    static void getBitsImpl_reset(svBitVecVal* value_reset);
    static void getBitsImpl_sum_0(svBitVecVal* value_sum_0);
    static void getBitsImpl_sum_1(svBitVecVal* value_sum_1);
    static void getBitsImpl_sum_2(svBitVecVal* value_sum_2);
    static void getBitsImpl_sum_3(svBitVecVal* value_sum_3);
    ...
    static void setBitsImpl_enable_sub(const svBitVecVal* value_enable_sub);
